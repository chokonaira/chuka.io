  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: 'description', content: 'Henry Okonkwo — Senior Software Engineer based in Berlin. Building WalletGate, Docgate, and Sprevia. 8 years shipping full-stack, native, and AI-powered products.' },
